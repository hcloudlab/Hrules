...
if "DOMAIN-SUFFIX,awswaf.com" in fin: errors.append("financial_account: generic awswaf.com capture is forbidden")o"/"editions"/f"hrules-{e}.js" for e in ("standard","stable","strict")]
files.append(ROOT/"mihomo"/"adapters"/"clash-verge-rev"/"hrules-global.js")
errors=[]
for p in files:
 s=p.read_text(encoding="utf-8")
