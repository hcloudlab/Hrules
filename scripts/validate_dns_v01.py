...
# Integration gates.
# Both public editions own their DNS baseline. Standard is conservative; Fine-grained\n# (legacy strict filename) keeps node bootstrap independent while using encrypted overseas DoH.
