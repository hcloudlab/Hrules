...
// Hrules Mihomo Fine-grained / 精细版
const HRULES_EDITION = "strict";
const HRULES_EDITION_SPEC = {"system_groups":[],"region_groups":true,"same_region_failover":false,"scene_groups":["sensitive_ai","crypto_account","us_banking_account","brokerage_account","financial_account","general_ai","youtube_media","mainstream_proxy","apple_global"],"scene_granularity":"fine","sensitive_exit_policy":"manual_region_or_node"};
