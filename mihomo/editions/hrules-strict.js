...
const HRULES_EDITION_SPEC = {"system_groups":["all","auto","fallback","load-balance"],"region_groups":true,"same_region_failover":true,"scene_groups":["sensitive_ai","crypto_account","us_banking_account","brokerage_account","general_ai","youtube_media","mainstream_proxy","apple_global"],"sensitive_exit_policy":"restricted"};
