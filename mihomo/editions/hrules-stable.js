...
const HRULES_EDITION_SPEC = {"system_groups":["all","auto","fallback"],"region_groups":true,"same_region_failover":true,"scene_groups":["sensitive_ai","general_ai","youtube_media"],"sensitive_exit_policy":"same_region_preferred"};
...
function main(config) {
  ...
  const owned = new Set([
    ...
    "🏦 美国银行 [场景]","📈 美股 [场景]","💳 支付金融 [场景]","🔐 重要账户 [场景]","🤖 AI 服务 [场景]","📺 YouTube [场景]","💬 Telegram [场景]",
    "🚀 漏网之鱼 [自选]"
  ]);
