...
| 🟡 **Stable / 稳定** | 尽量保持地区与出口一致 | 敏感场景减少节点漂移 | Claude / OpenAI、Netflix、Apple / iCloud 等 |
...
| **Shadowrocket** | ✅ Available | [Shadowrocket 配置安装](docs/clients/shadowrocket.md) |
...
### 社交与通信
**Telegram · TikTok · Facebook · Instagram · WhatsApp · X / Twitter · Discord · Reddit**

### 影音
**YouTube · Netflix · Disney+ · Prime Video · Spotify · Twitch**

### 平台与生态
**Apple 中国大陆服务 · Apple 国际服务 · iCloud · Apple Private Relay · Apple Intelligence · Google · GitHub · Microsoft**
...
Hrules 的 Mihomo 配置包含面向中国网络环境的 DNS 规则设计。DNS 与路由是两个不同层面：路由规则决定请求最终走 DIRECT 还是代理场景，DNS 负责域名解析路径。错误的 DNS 配置可能表现为节点正常但域名打不开、解析异常或出现不符合预期的访问路径。
